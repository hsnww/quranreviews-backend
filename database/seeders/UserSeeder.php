...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        $students = [
            [
                'name' => 'حسن ابو علوان',
                'email' => 'hsnwww@gmail.com',
                'phone' => '966505943390',
                'dob' => '2011-02-18',
                'institution' => 'جامع البراء بن عازب',
                'memorized_parts' => 17,
        ...
        foreach ($students as $data) {
            ...
            Student::create([
                ...
                'preferred_review_days' => $data['preferred_review_days'],
                'review_quarters_per_day' => $data['review_quarters_per_day'],
                'new_memorization_mode' => $data['new_memorization_mode'],
            ]);
        }
    }
}
